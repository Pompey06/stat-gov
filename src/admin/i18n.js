   ...
   ru: {
      translation: {
         ...
         databaseUpdate: {
            ...
            oldDbSubtitle: "Выгрузить старые пары вопрос-ответ в xlsx",
            oldDbFileFieldText: "Выбрать файл",
            newQATitle: "Добавить новые вопросы и ответы",
            newQASubtitle: "Реализовать подгрузку новой пары вопрос-ответ в xlsx",
   ...
   kz: {
      translation: {
         ...
         databaseUpdate: {
            ...
            oldDbSubtitle: "xlsx форматында ескі сұрақ-жауап жұптарын шығару",
            oldDbFileFieldText: "Файлды таңдау",
            newQATitle: "Жаңа сұрақтар мен жауаптарды қосу",
            newQASubtitle: "xlsx форматында жаңа сұрақ-жауап жұптарын жүктеу",
