  ...
  ru: {
    translation: {
      ...
      analytics: {
        ...
        langfuse: {
          title: "Langfuse",
          connected: "Мониторинг запросов, трассировок и качества ответов ИИ-помощника.",
  ...
  kz: {
    translation: {
      ...
      analytics: {
        ...
        langfuse: {
          title: "Langfuse",
          connected: "ИИ-көмекшінің сұраныстарын, трассировкаларын және жауап сапасын мониторингтеу.",
