...
export default function RegistrationModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const endpoint =
        entityType === "physical"
          ? `/form/submit-form/individual`
          : `/form/submit-form/corporate`;
      ...
      if (sendSuccessMessageToChat && requestId && addBotMessage) {
        ...
        {isSuccess ? (
          <div className="registration-success">
            ...
            <div className="mt-6 flex justify-end">
              <button
                className="feedback__button bg-blue text-white"
                onClick={handleClose}
              >
                {t("modal.close")}
              </button>
